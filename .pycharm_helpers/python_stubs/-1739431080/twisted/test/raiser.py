...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe3de77eac8>'

__spec__ = None # (!) real value is "ModuleSpec(name='twisted.test.raiser', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe3de77eac8>, origin='/usr/lib/python3/dist-packages/twisted/test/raiser.cpython-36m-x86_64-linux-gnu.so')"
