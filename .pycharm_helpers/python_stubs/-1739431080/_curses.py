...
_C_API = None # (!) real value is '<capsule object "_curses._C_API" at 0x7fe3dd6500f0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe3de77e9e8>'

__spec__ = None # (!) real value is "ModuleSpec(name='_curses', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe3de77e9e8>, origin='/usr/lib/python3.6/lib-dynload/_curses.cpython-36m-x86_64-linux-gnu.so')"
