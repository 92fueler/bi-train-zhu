...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc6a9e1d4a8>'

__spec__ = None # (!) real value is "ModuleSpec(name='_lzma', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc6a9e1d4a8>, origin='/usr/lib/python3.6/lib-dynload/_lzma.cpython-36m-x86_64-linux-gnu.so')"
