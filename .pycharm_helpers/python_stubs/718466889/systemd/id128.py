...
__spec__ = None # (!) real value is "ModuleSpec(name='systemd.id128', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc6a9dc12b0>, origin='/usr/lib/python3/dist-packages/systemd/id128.cpython-36m-x86_64-linux-gnu.so')"
