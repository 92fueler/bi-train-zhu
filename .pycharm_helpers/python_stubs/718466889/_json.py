...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc6aa1ac048>'

__spec__ = None # (!) real value is "ModuleSpec(name='_json', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc6aa1ac048>, origin='/usr/lib/python3.6/lib-dynload/_json.cpython-36m-x86_64-linux-gnu.so')"
