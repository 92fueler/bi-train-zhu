...
_C_API = None # (!) real value is '<capsule object "_curses._C_API" at 0x7fc6a8d83120>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc6a9eb3a20>'

__spec__ = None # (!) real value is "ModuleSpec(name='_curses', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc6a9eb3a20>, origin='/usr/lib/python3.6/lib-dynload/_curses.cpython-36m-x86_64-linux-gnu.so')"
