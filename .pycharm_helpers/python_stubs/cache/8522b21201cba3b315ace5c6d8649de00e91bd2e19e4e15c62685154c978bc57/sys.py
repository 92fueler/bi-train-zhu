...
meta_path = [
    ...
    None, # (!) real value is '<six._SixMetaPathImporter object at 0x7fc6a8e444a8>'
]
...
path_hooks = [
    ...
    None, # (!) real value is '<function FileFinder.path_hook.<locals>.path_hook_for_FileFinder at 0x7fc6ab92a6a8>'
]
