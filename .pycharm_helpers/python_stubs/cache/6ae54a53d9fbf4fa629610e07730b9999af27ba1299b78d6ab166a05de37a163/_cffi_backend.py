...
_C_API = None # (!) real value is '<capsule object "cffi" at 0x7fc6a8d831b0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc6a9eb3a20>'

__spec__ = None # (!) real value is "ModuleSpec(name='_cffi_backend', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc6a9eb3a20>, origin='/usr/lib/python3/dist-packages/_cffi_backend.cpython-36m-x86_64-linux-gnu.so')"
