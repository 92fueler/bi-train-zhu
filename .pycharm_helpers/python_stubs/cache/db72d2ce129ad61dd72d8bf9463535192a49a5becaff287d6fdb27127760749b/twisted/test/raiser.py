...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc6a9eb39b0>'

__spec__ = None # (!) real value is "ModuleSpec(name='twisted.test.raiser', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc6a9eb39b0>, origin='/usr/lib/python3/dist-packages/twisted/test/raiser.cpython-36m-x86_64-linux-gnu.so')"
