...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe3dd6f9278>'

__spec__ = None # (!) real value is "ModuleSpec(name='MySQLdb._mysql', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fe3dd6f9278>, origin='/usr/local/lib/python3.6/dist-packages/MySQLdb/_mysql.cpython-36m-x86_64-linux-gnu.so')"
